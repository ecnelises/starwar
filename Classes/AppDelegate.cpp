...
{
    // audio initialize
    CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect(Config::File::knockAudio);
    CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect(Config::File::enterBattleAudio);
    CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect(Config::File::itemClickAudio);
    CocosDenshion::SimpleAudioEngine::getInstance()->preloadBackgroundMusic(Config::File::menuSceneMusic);
}
